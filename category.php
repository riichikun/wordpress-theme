...
<body>
    ...
    <div class="posts-scroll flex flex-nowrap gap-[20px] p-[4.45%] overflow-auto">  
...
foreach( $my_posts as $post ){
    ...
    <div class='flex flex-col gap-[20px] w-[260px] min-w-[260px] lg:w-[20%] lg:min-w-0'>
        ...
        <div class='post-prewiev__block h-[200px] '>
...
<div>
	...
	// output: the_title() ...
        ...
        ?>
        <div class="flex gap-[4.45%] posts-row w-[100%] h-fit px-[4.45%]">
